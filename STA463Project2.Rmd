...
eliminated<- subset(airbnbNO, airbnbNO$logrstandard > -3 & airbnbNO$logrstandard < 3)

airbnbNO.lm.log <- lm(log(price) ~ log(cleanliness_rating) + log(dist) + private_room + shared_room, data=eliminated)
...
eliminated<- subset(airbnb.mod, airbnb.mod$logrstandard > -3 & airbnb.mod$logrstandard < 3)

airbnb.lm.log.noOut <- lm(log(price) ~ log(cleanliness_rating) + log(dist) + private_room + shared_room, data=eliminated)
summary(airbnb.lm.log.noOut)
```
